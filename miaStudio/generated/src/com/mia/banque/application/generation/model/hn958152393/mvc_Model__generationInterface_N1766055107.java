...
public class mvc_Model__generationInterface_N1766055107 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__generationInterface_N1766055107() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__generationInterface_N1766055107(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"generationInterface", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''generationInterface''");
...
_template_buffer.append(manager.action(current, "declarationMethodes"));_template_buffer.append('\n');
_template_buffer.append("}");
