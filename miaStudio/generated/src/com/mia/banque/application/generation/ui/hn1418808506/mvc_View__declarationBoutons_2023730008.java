...
public class mvc_View__declarationBoutons_2023730008 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__declarationBoutons_2023730008() {
		//Do nothing
	}

	//For internal use only
	mvc_View__declarationBoutons_2023730008(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"declarationBoutons", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''declarationBoutons''");
...
return manager.apply(current.getActions(), "actionBoutonsDeclaration");
