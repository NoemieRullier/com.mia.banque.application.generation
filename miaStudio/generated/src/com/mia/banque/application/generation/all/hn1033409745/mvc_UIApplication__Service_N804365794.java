package com.mia.banque.application.generation.all.hn1033409745;
...
public class mvc_UIApplication__Service_N804365794 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_UIApplication__Service_N804365794() {
		//Do nothing
	}

	//For internal use only
	mvc_UIApplication__Service_N804365794(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"Service", argument.getClass().getName(),
	...
	public Object runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''Service''");
