...
public class mvc_ModelProperty__xxx_N507895585 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__xxx_N507895585() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__xxx_N507895585(int anyInt, List anyList) {
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''xxx''");
