...
public class mvc_Model__MacroOwnedElementsVariableDeclaration_1105847818 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__MacroOwnedElementsVariableDeclaration_1105847818() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__MacroOwnedElementsVariableDeclaration_1105847818(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"MacroOwnedElementsVariableDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''MacroOwnedElementsVariableDeclaration''");
