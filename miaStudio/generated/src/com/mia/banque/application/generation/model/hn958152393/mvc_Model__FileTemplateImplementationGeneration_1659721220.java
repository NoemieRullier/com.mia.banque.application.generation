...
public class mvc_Model__FileTemplateImplementationGeneration_1659721220 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__FileTemplateImplementationGeneration_1659721220() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__FileTemplateImplementationGeneration_1659721220(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"FileTemplateImplementationGeneration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''FileTemplateImplementationGeneration''");
...
_template_buffer.append(manager.action(current, "name"));_template_buffer.append(" implements com.mia.banque.model.I");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append(" {");
_template_buffer.append('\n');
_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "MacroOEVariableDeclaration"));_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "MacroPropertiesVariableDeclaration"));_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "MacroOEMethodsGetterImpl"));_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "MacroOEMethodsSetterImpl"));_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "MacroPropertiesMethodsGetterImpl"));_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "MacroPropertiesMethodsSetterImpl"));_template_buffer.append('\n');
_template_buffer.append('\n');
_template_buffer.append("}");
