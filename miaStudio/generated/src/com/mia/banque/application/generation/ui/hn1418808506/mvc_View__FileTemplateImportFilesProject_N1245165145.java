...
public class mvc_View__FileTemplateImportFilesProject_N1245165145 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__FileTemplateImportFilesProject_N1245165145() {
		//Do nothing
	}

	//For internal use only
	mvc_View__FileTemplateImportFilesProject_N1245165145(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"FileTemplateImportFilesProject", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''FileTemplateImportFilesProject''");
...
_template_buffer.append(manager.action(current, "MacroModelName"));_template_buffer.append("Controler;");
_template_buffer.append('\n');
_template_buffer.append("import com.mia.banque.ui.view.I");
_template_buffer.append(manager.action(current, "MacroModelName"));_template_buffer.append("View;");
_template_buffer.append('\n');
_template_buffer.append("import com.mia.banque.model.I");
_template_buffer.append(manager.action(current, "MacroModelName"));_template_buffer.append(";");
