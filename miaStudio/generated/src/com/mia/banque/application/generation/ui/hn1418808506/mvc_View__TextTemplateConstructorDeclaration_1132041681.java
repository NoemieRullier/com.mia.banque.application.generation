...
public class mvc_View__TextTemplateConstructorDeclaration_1132041681 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__TextTemplateConstructorDeclaration_1132041681() {
		//Do nothing
	}

	//For internal use only
	mvc_View__TextTemplateConstructorDeclaration_1132041681(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"TextTemplateConstructorDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''TextTemplateConstructorDeclaration''");
...
_template_buffer.append("		");
_template_buffer.append(manager.action(current, "MacroGroupsImplementation"));_template_buffer.append('\n');
_template_buffer.append("		");
_template_buffer.append('\n');
