...
public class mvc_ModelProperty__TextTemplateVariableGetterDeclaration_1190407891 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__TextTemplateVariableGetterDeclaration_1190407891() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__TextTemplateVariableGetterDeclaration_1190407891(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"TextTemplateVariableGetterDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''TextTemplateVariableGetterDeclaration''");
