...
public class mvc_View__generationControlerClasse_Filename_1622092849 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__generationControlerClasse_Filename_1622092849() {
		//Do nothing
	}

	//For internal use only
	mvc_View__generationControlerClasse_Filename_1622092849(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"generationControlerClasse$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''generationControlerClasse$Filename''");
...
_template_buffer.append("src/com/mia/banque/ui/controler/swt/");
