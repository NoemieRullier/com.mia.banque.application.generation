...
public class mvc_View__implantationMethodes_N1824904345 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__implantationMethodes_N1824904345() {
		//Do nothing
	}

	//For internal use only
	mvc_View__implantationMethodes_N1824904345(int anyInt, List anyList) {
