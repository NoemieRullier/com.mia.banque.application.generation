...
public class mvc_Model__FileTemplateGenerationClasse_1060945599 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__FileTemplateGenerationClasse_1060945599() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__FileTemplateGenerationClasse_1060945599(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"FileTemplateGenerationClasse", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''FileTemplateGenerationClasse''");
...
_template_buffer.append(manager.action(current, "declarationAttributs"));_template_buffer.append('\n');
