...
public class mvc_Model__declarationMethodes_182152485 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__declarationMethodes_182152485() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__declarationMethodes_182152485(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"declarationMethodes", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''declarationMethodes''");
...
for (Model element : current.getOwnedElements()){
	 result += manager.getString(element, "variableGetterDeclaration");
