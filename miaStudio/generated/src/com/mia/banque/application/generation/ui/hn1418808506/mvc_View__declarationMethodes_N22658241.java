...
public class mvc_View__declarationMethodes_N22658241 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__declarationMethodes_N22658241() {
		//Do nothing
	}

	//For internal use only
	mvc_View__declarationMethodes_N22658241(int anyInt, List anyList) {
...
return manager.apply(current.getActions(), "actionDeclaration");
