...
public class mvc_View__FileTemplateInterfaceGeneration_Filename_1641876533 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__FileTemplateInterfaceGeneration_Filename_1641876533() {
		//Do nothing
	}

	//For internal use only
	mvc_View__FileTemplateInterfaceGeneration_Filename_1641876533(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"FileTemplateInterfaceGeneration$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''FileTemplateInterfaceGeneration$Filename''");
...
_template_buffer.append("src/com/mia/banque/ui/view/I");
