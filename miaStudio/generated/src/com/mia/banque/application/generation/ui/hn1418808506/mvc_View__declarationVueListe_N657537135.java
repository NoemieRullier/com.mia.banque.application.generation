...
public class mvc_View__declarationVueListe_N657537135 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__declarationVueListe_N657537135() {
		//Do nothing
	}

	//For internal use only
	mvc_View__declarationVueListe_N657537135(int anyInt, List anyList) {
