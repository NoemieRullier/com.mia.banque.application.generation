...
public class mvc_Model__TextTemplateVariableGetterImplementation_N1032426492 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__TextTemplateVariableGetterImplementation_N1032426492() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__TextTemplateVariableGetterImplementation_N1032426492(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"TextTemplateVariableGetterImplementation", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''TextTemplateVariableGetterImplementation''");
...
_template_buffer.append("	public List<com.mia.banque.model.I");
...
_template_buffer.append(manager.action(current, "name"));_template_buffer.append(" = new ArrayList<com.mia.banque.model.I");
