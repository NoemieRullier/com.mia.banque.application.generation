...
public class mvc_Model__TextTemplateGroupsImplementation_1770640241 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__TextTemplateGroupsImplementation_1770640241() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__TextTemplateGroupsImplementation_1770640241(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"TextTemplateGroupsImplementation", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''TextTemplateGroupsImplementation''");
...
_template_buffer.append("		");
_template_buffer.append('\n');
_template_buffer.append("		for (final com.mia.banque.model.I");
