...
public class mvc_Model__TextTemplateVariableDeclaration_871668531 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__TextTemplateVariableDeclaration_871668531() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__TextTemplateVariableDeclaration_871668531(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"TextTemplateVariableDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''TextTemplateVariableDeclaration''");
...
_template_buffer.append("	private List<com.mia.banque.model.I");
