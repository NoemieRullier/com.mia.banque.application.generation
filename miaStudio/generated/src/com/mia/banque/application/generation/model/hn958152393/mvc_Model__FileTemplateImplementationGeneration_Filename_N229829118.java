...
public class mvc_Model__FileTemplateImplementationGeneration_Filename_N229829118 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__FileTemplateImplementationGeneration_Filename_N229829118() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__FileTemplateImplementationGeneration_Filename_N229829118(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"FileTemplateImplementationGeneration$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''FileTemplateImplementationGeneration$Filename''");
...
_template_buffer.append("src/com/mia/banque/model/impl/");
