...
public class mvc_Action__TextTemplateButtonDeclaration_N2064433370 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__TextTemplateButtonDeclaration_N2064433370() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__TextTemplateButtonDeclaration_N2064433370(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"TextTemplateButtonDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''TextTemplateButtonDeclaration''");
